...
export ROS_IP=192.168.1.164 
export LD_LIBRARY_PATH=/usr/local/lib:/opt/ros/melodic/lib
alias c='clear'
alias r='reset'
alias h='history'
alias sds='source devel/setup.bash'
alias sgs='source /opt/ros/melodic/setup.bash'
alias cm='catkin_make -DCATKIN_ENABLE_TESTING=False -DCMAKE_BUILD_TYPE=Release; catkin_make install; source devel/setup.bash'
alias dep='rosdep install --from-paths src --ignore-src --rosdistro=melodic -y'
